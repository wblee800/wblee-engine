...
namespace wb
{
	WBTheaterScreenScene::WBTheaterScreenScene()
		:mPlayer(nullptr)
	{
	}
	...
	void WBTheaterScreenScene::Initialize()
	{
		...
		graphics::WBTexture* mapTexture = WBResources::Find<graphics::WBTexture>(L"Theater_Screen");
	...
	void WBTheaterScreenScene::Update()
	{
		WBScene::Update();
	}

	void WBTheaterScreenScene::LateUpdate()
	{
		WBScene::LateUpdate();
	...
	void WBTheaterScreenScene::Render(HDC hdc)
	{
		WBScene::Render(hdc);
	...
	void WBTheaterScreenScene::OnEnter()
	{
	}

	void WBTheaterScreenScene::OnExit()
	{
	}
}