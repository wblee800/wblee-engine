...
namespace wb
{
	WBBlacksmithScene::WBBlacksmithScene()
		:mPlayer(nullptr),
		mCamera(nullptr)
	{
	}
	...
	void WBBlacksmithScene::Initialize()
	{
		...
		playerAnimator->CreateAnimation(L"PlayerIdleLeft", playerTexture,
			Vector2(250.0f * 6, 0.0f), Vector2(250.0f, 250.0f), Vector2::Zero, 1, 0.1f);
		...
		playerAnimator->CreateAnimation(L"PlayerIdleDown", playerTexture,
			Vector2(250.0f * 11, 250.0f), Vector2(250.0f, 250.0f), Vector2::Zero, 1, 0.1f);
		...
		playerAnimator->CreateAnimation(L"PlayerHoeDown", playerTexture,
			Vector2(0.0f, 250.0f * 4), Vector2(250.0f, 250.0f), Vector2::Zero, 3, 00.1f);
		...
		playerAnimator->CreateAnimation(L"PlayerIrrigateDown", playerTexture,
			Vector2(0.0f, 250.0f * 8), Vector2(250.0f, 250.0f), Vector2::Zero, 12, 00.1f);
		...
		playerAnimator->CreateAnimation(L"PlayerIrrigateUp", playerTexture,
			Vector2(250.0f * 5, 250.0f * 9), Vector2(250.0f, 250.0f), Vector2::Zero, 3, 00.1f);
	...
	void WBBlacksmithScene::Update()
	{
		WBScene::Update();
	}

	void WBBlacksmithScene::LateUpdate()
	{
		WBScene::LateUpdate();
	...
	void WBBlacksmithScene::Render(HDC hdc)
	{
	...
	void WBBlacksmithScene::OnEnter()
	{
		renderer::mainCamera = mCamera->GetComponent<WBCamera>();
	}

	void WBBlacksmithScene::OnExit()
	{
	}
}