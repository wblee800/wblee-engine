...
namespace wb
{
	...
	void WBSkullCavernEntranceScene::Initialize()
	{
	...
	void WBSkullCavernEntranceScene::Update()
	{
		WBScene::Update();
	}

	void WBSkullCavernEntranceScene::LateUpdate()
	{
		WBScene::LateUpdate();

		if (WBInput::GetKeyDown(eKeyCode::W))
		{
			WBSceneManager::LoadScene(L"SkullCavernScene");
		}
