...
namespace wb
{
	WBStardropSaloonScene::WBStardropSaloonScene()
		:mPlayer(nullptr),
		mCamera(nullptr)
	{
	}
	...
	void WBStardropSaloonScene::Initialize()
	{
		// Camera
		...
		graphics::WBTexture* mapTexture = WBResources::Find<graphics::WBTexture>(L"Stardrop_Saloon");
	...
	void WBStardropSaloonScene::Update()
	{
		WBScene::Update();
	}

	void WBStardropSaloonScene::LateUpdate()
	{
		WBScene::LateUpdate();
	...
	void WBStardropSaloonScene::Render(HDC hdc)
	{
	...
	void WBStardropSaloonScene::OnEnter()
	{
		renderer::mainCamera = mCamera->GetComponent<WBCamera>();
	}

	void WBStardropSaloonScene::OnExit()
	{
	}
}