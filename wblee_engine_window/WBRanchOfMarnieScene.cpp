...
namespace wb
{
	WBRanchOfMarnieScene::WBRanchOfMarnieScene()
		:mPlayer(nullptr),
		mCamera(nullptr)
	{
	}
	...
	void WBRanchOfMarnieScene::Initialize()
	{
		...
		graphics::WBTexture* mapTexture = WBResources::Find<graphics::WBTexture>(L"Ranch_Of_Marnie");
	...
	void WBRanchOfMarnieScene::Update()
	{
		WBScene::Update();
	}

	void WBRanchOfMarnieScene::LateUpdate()
	{
		WBScene::LateUpdate();
	...
	void WBRanchOfMarnieScene::Render(HDC hdc)
	{
	...
	void WBRanchOfMarnieScene::OnEnter()
	{
		renderer::mainCamera = mCamera->GetComponent<WBCamera>();
	}

	void WBRanchOfMarnieScene::OnExit()
	{
	}
}