...
namespace wb
{
	WBFarmhouseScene::WBFarmhouseScene()
		:mPlayer(nullptr),
		mCamera(nullptr)
	{
	}
	...
	void WBFarmhouseScene::Initialize()
	{
	...
	void WBFarmhouseScene::Update()
	{
		WBScene::Update();
	}

	void WBFarmhouseScene::LateUpdate()
	{
		WBScene::LateUpdate();
	...
	void WBFarmhouseScene::Render(HDC hdc)
	{
	...
	void WBFarmhouseScene::OnEnter()
	{
		renderer::mainCamera = mCamera->GetComponent<WBCamera>();
	}

	void WBFarmhouseScene::OnExit()
	{
	}
}